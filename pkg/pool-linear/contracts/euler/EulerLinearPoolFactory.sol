...
contract EulerLinearPoolFactory is ILastCreatedPoolFactory, BasePoolFactory, ReentrancyGuard, FactoryWidePauseWindow {
    ...
    ) BasePoolFactory(vault, protocolFeeProvider, type(EulerLinearPool).creationCode) {
        _queries = queries;
    }
    ...
    function create(
        ...
        EulerLinearPool.ConstructorArgs memory args = EulerLinearPool.ConstructorArgs({
            vault: getVault(),
            name: name,
            symbol: symbol,
            mainToken: mainToken,
